...
@click.command()
@click.option('--exploit_data_directory', 
              default="/Users/jacobdineen/Documents/copy20221006/files/train_19700101_20210401/exploits_text", 
              show_default=True,
              help="Path to the directory containing exploit JSON files.")
@click.option('--documents_path', 
              default="/Users/jacobdineen/Documents/copy20221006/files/train_19700101_20210401/documents.json", 
              show_default=True,
              help="Path to the documents JSON file.")
@click.option('--labels_directory', 
              default="/Users/jacobdineen/Documents/copy20221006/documents/train_19700101_20210401", 
              show_default=True,
              help="Path to the directory containing label JSON files.")
@click.option('--export_path', default="data", required=True, help="Path where the merged CSV will be saved (without .csv extension).")
...
@click.option('--export_model_path', 
              default="model", 
              show_default=True,
              help="Model path")
...
@click.option('--model_path', 
              ...
              show_default=True,
              help="Model path")
@click.option('--vectorizer_path', 
              default="model_vectorizer", 
              show_default=True,
              help="vec path")
@click.option('--out_path', 
              default="scored_data", 
              show_default=True,
              help="scored data path")
